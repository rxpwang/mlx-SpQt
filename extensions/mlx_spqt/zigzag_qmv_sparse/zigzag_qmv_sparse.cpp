...
void ZigzagQmvSparse::eval_gpu(
  ...
  throw std::runtime_error("ZigzagQmvSparse has no GPU implementation.");
}
...
std::vector<mx::array> ZigzagQmvSparse::jvp(
    const std::vector<mx::array>& primals,
    const std::vector<mx::array>& tangents,
    const std::vector<int>& argnums) {
  throw std::runtime_error("ZigzagQmvSparse has no jvp implementation.");
}

/** The vector-Jacobian product. */
std::vector<mx::array> ZigzagQmvSparse::vjp(
    const std::vector<mx::array>& primals,
    const std::vector<mx::array>& cotangents,
    const std::vector<int>& argnums,
    const std::vector<mx::array>&) {
  throw std::runtime_error("ZigzagQmvSparse has no vjp implementation.");
}

/** Vectorize primitive along given axis */
std::pair<std::vector<mx::array>, std::vector<int>> ZigzagQmvSparse::vmap(
    const std::vector<mx::array>& inputs,
    const std::vector<int>& axes) {
  throw std::runtime_error("ZigzagQmvSparse has no vmap implementation.");
}
