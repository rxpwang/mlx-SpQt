...
void SmokeAtomic::eval_gpu(
  ...
  throw std::runtime_error("SmokeAtomic has no GPU implementation.");
}
...
std::vector<mx::array> SmokeAtomic::jvp(
    const std::vector<mx::array>& primals,
    const std::vector<mx::array>& tangents,
    const std::vector<int>& argnums) {
  throw std::runtime_error("SmokeAtomic has no jvp implementation.");
}

/** The vector-Jacobian product. */
std::vector<mx::array> SmokeAtomic::vjp(
    const std::vector<mx::array>& primals,
    const std::vector<mx::array>& cotangents,
    const std::vector<int>& argnums,
    const std::vector<mx::array>&) {
  throw std::runtime_error("SmokeAtomic has no vjp implementation.");
}

/** Vectorize primitive along given axis */
std::pair<std::vector<mx::array>, std::vector<int>> SmokeAtomic::vmap(
    const std::vector<mx::array>& inputs,
    const std::vector<int>& axes) {
  throw std::runtime_error("SmokeAtomic has no vmap implementation.");
}

/** Equivalence check **/
bool SmokeAtomic::is_equivalent(const Primitive& other) const {
  const SmokeAtomic& r_other = static_cast<const SmokeAtomic&>(other);
